    ...
    <>
      <div className="bg-backgroudGray">
        <div>
          <div>
            <div className="grid-container">
              <div className="item1 margin-top w-[250px]">
                <div>
                  <span className="w-[160px] inline-block">
                    <img src="/images/swiggy-logo-01.svg" alt="" />
                  </span>
                </div>
                <div className="opacity-60 font-medium tracking-tighter text-[15px]">
                  © 2024 Swiggy Limited
                </div>
              </div>
              <div className="item2">
        ...
        <div className="wrapper !w-[90%]">
          <div className="pt-[32px] pb-[48px] border-t-[1px] border-black flex justify-center gap-[32] items-center">
            <div>
              <h3 className="text-[23px] font-bold opacity-[0.7] tracking-[-0.6px]">
